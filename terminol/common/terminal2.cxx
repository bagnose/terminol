...
void Terminal2::processEscape(char c) {
    switch (c) {
        case 'D':   // IND - linefeed
            NYI("st.c:2169");
            break;
...
void Terminal2::processCsi(const std::vector<char> & seq) {
...
void Terminal2::processDcs(const std::vector<char> & seq) {
    PRINT("NYI:DCS: " << Str(seq));
}

void Terminal2::processOsc(const std::vector<char> & seq) {
...
void Terminal2::processSpecial(const std::vector<char> & seq) {
    PRINT("NYI:SPECIAL: " << Str(seq));
}

void Terminal2::processAttributes(const std::vector<int32_t> & args) {
...
void Terminal2::processModes(bool priv, bool set, const std::vector<int32_t> & args) {
